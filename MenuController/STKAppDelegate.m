...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    STKMenuViewController *mvc = [[STKMenuViewController alloc] init];
//    UITabBarController *mvc = [[UITabBarController alloc] init];
    [mvc setViewControllers:@[
        [[STKMapViewController alloc] init],
        [[STKAccountViewController alloc] init],
        [[UINavigationController alloc] initWithRootViewController:[[STKHelpViewController alloc] init]]
    ]];
